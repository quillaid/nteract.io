...
title: "TODO — write the headline (the payload, not 'v2.2 released')"
summary: "TODO — one sentence describing this release to a notebook user."
highlights:
  - "enable conda hot-sync for inline dependencies"
  - "return per-cell outputs from run_all_cells"
  - "content-aware multi-cell renderer with dev preview"
  - "add 'kernel' alias for 'runtime' in create_notebook"
tags:
  - "Outputs"
  - "Agents"
  - "Collaboration"
