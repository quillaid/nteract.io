...
title: "TODO — write the headline (the payload, not 'v2.4 released')"
summary: "TODO — one sentence describing this release to a notebook user."
highlights:
  - "add one-shot PutBlob uploads"
  - "add PutBlob one-shot clients"
  - "round-trip frontend binary widget state via PutBlob"
  - "add ephemeral durability hint"
tags:
  - "Outputs"
  - "Agents"
  - "Collaboration"
