...
This release brings our brush filtering data explorer built on [pretext](https://chenglou.me/pretext/) and [Apache Arrow](https://arrow.apache.org/) to every dataframe in Python: `pandas`, `polars`, `datasets`, `narwhals`, `duckdb`, maybe more.
