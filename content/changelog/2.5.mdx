...
title: "Sift DataFrames, Rich Tracebacks, Secret Scrubbing"
summary: "DataFrames render in Sift, tracebacks are rich and navigable, and secret env values get scrubbed from outputs."
highlights:
  - "Python errors render as rich, structured tracebacks"
  - "DataFrames render in Sift, an interactive crossfilter explorer"
