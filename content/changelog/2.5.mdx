...
highlights:
  - "Tracebacks Python errors render as rich, structured tracebacks"
...
This release brings our cross filtering data explorer built on [pretext](https://chenglou.me/pretext/) and [Apache Arrow](https://arrow.apache.org/) to every dataframe in Python: `pandas`, `polars`, `datasets`, `narwhals`, `duckdb`, maybe more.

## Rich tracebacks

{/* TODO: Add traceback GIF */}

Python errors now render as structured, navigable tracebacks. Stack frames are collapsible and you get direct links back to your cells.
