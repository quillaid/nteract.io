...
2.5 brings our brush filtering data explorer built on [pretext](https://chenglou.me/pretext/) and [Apache Arrow](https://arrow.apache.org/) to every dataframe in Python: `pandas`, `polars`, `datasets`, `narwhals`, `duckdb`: wherever `__arrow_c_stream__` can be found.
