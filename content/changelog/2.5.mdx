...
title: "[redacted] Secrets, Sift DataFrames, Rich Tracebacks"
summary: "The nteract 2.5 release invites you to stop leaking credentials in notebooks, emit Arrow for rich data exploration, and get teleported with tracebacks."
highlights:
  - "Python errors render as rich, structured tracebacks"
  - "Rich DataFrame explorer with interactive crossfiltering"
...
2.5 brings rich context tracebacks, less leaky env vars, and a brush filtering data explorer built on [pretext](https://chenglou.me/pretext/) and [Apache Arrow](https://arrow.apache.org/) to every dataframe in Python: `pandas`, `polars`, `datasets`, `narwhals`, `duckdb`; wherever `__arrow_c_stream__` can be found.

I've always wanted an Arrow-native notebook for data work. Here it is.

## Rich tracebacks

{/* TODO: Add traceback GIF */}

Python errors now render as structured, navigable tracebacks. Stack frames are collapsible with direct links back to your cells.

## DataFrames open in Sift

{/* TODO: Add DataFrame GIF */}
...
{/* TODO: Screenshot of output having secret */}
