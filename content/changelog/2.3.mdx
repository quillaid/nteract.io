...
title: "TODO — write the headline (the payload, not 'v2.3 released')"
summary: "TODO — one sentence describing this release to a notebook user."
highlights:
  - "move path to RuntimeStateDoc, drop NotebookAutosaved + PathChanged + frontend dirty"
  - "per-type frame caps with warn-then-error logging"
  - "ephemeral clone replaces Save As Copy"
  - "scaffold ProjectContext on RuntimeStateDoc"
tags:
  - "Outputs"
  - "Agents"
  - "Collaboration"
